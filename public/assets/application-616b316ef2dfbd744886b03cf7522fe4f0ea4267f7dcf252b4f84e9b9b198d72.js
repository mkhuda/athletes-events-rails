...
function date_populate(dayfield, monthfield, yearfield){
    ...
    for (var m=0; m<12; m++)
        monthfield.options[m]=new Option(monthnum[m], monthtext[m])
        monthfield.options[today.getMonth()]=new Option(monthnum[today.getMonth()], monthtext[today.getMonth()], true, true) //select today's month
